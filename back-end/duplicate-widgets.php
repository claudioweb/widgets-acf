...
Class DuplicateWidgets {
	...
	public function __construct() {
		add_action('admin_action_rd_duplicate_post_as_draft', array($this, 'duplicatePostAsDraft'));

		add_filter('post_row_actions', array($this, 'duplicatePostLink') , 10, 2);
		add_filter('page_row_actions', array($this, 'duplicatePostLink') , 10, 2);

		$categories = Utils::getTaxonomies();

		foreach($categories as $tax => $cat)
			add_filter( $tax.'_row_actions', array($this, 'duplicatePostLink') , 10, 2);
	}
